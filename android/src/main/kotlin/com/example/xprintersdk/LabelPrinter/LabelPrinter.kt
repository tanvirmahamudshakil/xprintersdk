...
//             .print(1);
         ...
         printer.sizeMm(64.0, 64.0)
             ...
             .reference(10, 0)
             .cls()
             .text(10, 150, TSPLConst.FNT_32_48, TSPLConst.ROTATION_0, 1, 1, productname)
             .text(10, 250, TSPLConst.FNT_32_48, TSPLConst.ROTATION_0, 1, 1, price)
             .text(270, 250, TSPLConst.FNT_32_48, TSPLConst.ROTATION_0, 1, 1, net)
             // New barcode under the price and net weight row
             .barcode(10, 300, TSPLConst.CODE_TYPE_93, 100, TSPLConst.READABLE_NONE, TSPLConst.ROTATION_0, 2, 2, barcode)
             // Text for total price and expiry date under the new barcode
             .text(10, 450, TSPLConst.FNT_32_48, TSPLConst.ROTATION_0, 1, 1, total)
             .text(270, 450, TSPLConst.FNT_32_48, TSPLConst.ROTATION_0, 1, 1, expire)
             .print(1);
    }
